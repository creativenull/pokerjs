...
/**
 * @typedef { import('deckjs').Card } Card
 * @typedef { import('../index').Player } Player
 * @typedef { import('../index').PlayerResult } PlayerResult
 * @typedef { import('../index').PokerHandRanking } PokerHandRanking
 * @typedef { import('../index')._StraightCheck } _StraightCheck
 * @typedef { import('../index')._FlushCheck } _FlushCheck
 * @typedef { import('../index')._PairsCheck } _PairsCheck
 */
...
class Poker extends Deck {
  ...
  _isFlush (hand) {
    for (const suit of Deck.SUITS) {
      const count = hand.reduce((acc, card) => acc + (card.suit.value === suit.value ? 1 : 0), 0)
